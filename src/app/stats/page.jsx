...
const StatsPage = () => {
  ...
  return (
    <div>
      ...
      <PieChart
        className="mx-auto bg-gray-50 shadow-2xl mb-4 rounded-2xl"
        width={400}
        height={400}
        aspectRatio={1}
      >
      ...
      <div className="flex gap-5 justify-center mb-4">
        <div className=" text-white px-2 rounded-sm bg-purple-600 text-sm">
          Call
        </div>
        <div className=" text-white px-2 rounded-sm bg-green-600 text-sm">
          Text
        </div>
        <div className=" text-white px-2 rounded-sm bg-red-600 text-sm">
          Video
        </div>
      </div>
    </div>
